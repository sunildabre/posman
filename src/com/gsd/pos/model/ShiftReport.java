...
public class ShiftReport {
	...
	public BigDecimal getGrandTotal() {
		...
		if (totals != null) {
			grandTotal = grandTotal.add(totals.getTotalFuelSales()).add(totals.getTotalDeptSales()).add(totals.getTotalTax())
					.add(totals.getFuelDiscounts()).add(totals.getOtherDiscounts());
		}
